...
class YARACompiler:
    ...
    def __init__(self, rules_dirs=None, auto_download=True, verbose=True):
        ...
        if auto_download:
            downloader = YARARuleDownloader.YARARuleDownloader()
            downloader.start()

        self.rules_dirs = rules_dirs or ["./custom_rules"]
...
if __name__ == "__main__":
    ...
    try:
        compiler = YARACompiler(rules_dirs=["./custom_rules"], auto_download=True)
